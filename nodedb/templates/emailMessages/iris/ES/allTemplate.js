(function(){
    ...
    EmailTemplate.prototype = {
        ...
        otpAuthFactor: function(data){
            return '<p>Una contraseña (OTP) para su transacción es ' + data.otp + ' . Banco nunca llama para verificar su OTP. No revele OTP a nadie.</p>';
        },
        ...
        bankAdminPassword: function(data){
            return '<p>Sus Admin Login Credenciales</p><p>ID de usuario: <b>' + data.userName +'</b></p><p>contraseña:  <b>'+ data.password +' </b></p><p>.Por razones de seguridad se recomienda no compartir su contraseña con nadie incluyendo personal del banco. Se le pide que cambie esta contraseña al iniciar sesión.</p><br/><p>Gracias y Saludos,</p><p>Banco</p>';
        },
        bankAdminPasswordChanged : function(data){
            return '<p> Estimado Admin, </p> <p> Su contraseña ha sido cambiada con éxito  </p> <p> Por razones de seguridad, recomendamos que no comparta su contraseña con nadie incluyendo personal del banco. </p> <br/> <p> Gracias y Saludos, </p> <p> El Banco </p>';
        },
        ...
        bankAdminProfileChanged : function(data){
            return '<p> Estimado Admin, </p> <p> Su perfil se ha cambiado correctamente  </p> <br/> <p> Gracias y Saludos, </p> <p> El Banco </p>';
        },
