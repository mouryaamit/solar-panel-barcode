(function(){
    ...
    EmailTemplate.prototype = {
        ...
        bankAdminPassword: function(data){
            return '<p>Your Admin,</p><p>Your Login Credentials are</p><p>UserID: <b>' + data.userName +'</b></p><p>Password:  <b>'+ data.password +'</b></p><p>For security reasons we recommend you not to share your password with anyone including bank staff. You are requested to change this password on login.</p><br/><p>Thanks & Regards,</p><p>Bank</p>';
        },
        bankAdminPasswordChanged : function(data){
            return '<p>Dear Admin,</p><p>Your Password Has Been Changed Successfully</b></p><p>For security reasons we recommend you not to share your password with anyone including bank staff. </p><br/><p>Thanks & Regards,</p><p>Bank</p>';
        },
        bankAdminLocked : function(data){
            return '<p>Dear Admin,</p><p>Your Profile Has Been Locked Due to multiple failed login attempts</b></p><br/><p>Thanks & Regards,</p><p>Bank</p>';
        },
        bankAdminLockedBySupervisor : function(data){
            return '<p>Dear Admin,</p><p>Your Profile Has Been Locked By Supervisor</b></p><br/><p>Thanks & Regards,</p><p>Bank</p>';
        },
        bankAdminUnlocked : function(data){
            return '<p>Dear Admin,</p><p>Your Profile Has Been Unlocked By Supervisor</b></p><br/><p>Thanks & Regards,</p><p>Bank</p>';
        },
        bankAdminDeleted : function(data){
            return '<p>Dear Admin,</p><p>Your Profile Has Been Deactivated By Supervisor</b></p><br/><p>Thanks & Regards,</p><p>Bank</p>';
        },
        bankAdminProfileChanged : function(data){
            return '<p>Dear Admin,</p><p>Your Profile Has Been Changed Successfully</b></p><br/><p>Thanks & Regards,</p><p>Bank</p>';
        },
