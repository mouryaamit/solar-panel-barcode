(function(){
    ...
    var bankPolicyMethod = require('../supportMethods/bankPasswordRuleMethods');
    ...
    function PasswordHistory(config , tnxId){
        ...
        this.model = mongoModelObj.modelName.AdminPasswordHistory;
    }

    PasswordHistory.prototype = {
        isPasswordInHistory: function(adminId , password , callback){
            ...
            bankPolicy.getBankPasswordRule(null , resHandle);
        },
        ...
        addPasswordHistory : function(adminId , password){
        ...
        passwordHistoryDb : function(err , result){
            if (!result){
                ...
                if(this.policyData.checkLastPassword != ""){

                    this.totalSize = parseInt(this.policyData.checkLastPassword);
