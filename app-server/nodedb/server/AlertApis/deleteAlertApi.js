(function () {
    ...
    function DeleteAlert(alertObj , callback , config , txnId) {
    ...
    module.exports.DeleteAlert = function(alertObj , callback , config , txnId){
        return (new DeleteAlert(alertObj , callback , config , txnId));
    };
})();