(function(){
    ...
    EmailTemplate.prototype = {
        ...
        statementEnrollment: function (data) {
            var template = '<p>Statements Enrollment'+data.accountNumber+'</p>';
            return template;
        ...
        resetPassword: function(data){
            return '<p>Dear '+ data.customerName +',</p><p>As per your request we have reset your password. Your new password is <b>'+ data.password +'</b>. For security reasons we recommend you not to share your password with anyone including bank staff. You are requested to change this password on login.</p><br/>';
        },
        forgottenUserId: function(data){
            return '<p>Dear '+ data.customerName +',</p><p>As per your request we have retrieved your UserID. Your userID is <b>'+ data.userId +'</b>. For security reasons we recommend you not to share your userId with anyone including bank staff. </p><br/>';
        },
        ...
        bankAdminPassword: function(data){
                return '<p>Your Admin Login Credentials</p><p>UserID: ' + data.userName +'</p><p>Password:  '+ data.password +' .For security reasons we recommend you not to share your password with anyone including bank staff. You are requested to change this password on login.</p><br/>';
        },
        userLoginPassword: function(data){
            return '<p>Dear '+ data.customerName+', </p>'+'<p>Your Login Password is <b>'+ data.password +'</b> .For security reasons we recommend you not to share your password with anyone including bank staff. You are requested to change this password on login.</p><br/>';
        },
        userLoginUserId: function(data){
            return '<p>Dear '+ data.customerName+', </p>'+'<p>Your Login userId is <b>' + data.userName +'</b> .For security reasons we recommend you not to share your userID with anyone including bank staff. </p><br/>';
        },
