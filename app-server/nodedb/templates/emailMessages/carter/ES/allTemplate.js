(function(){
    ...
    EmailTemplate.prototype = {
        ...
        userLoginPassword: function(data){
            return '<p> Estimado ' + data.customerName + ' , </p> ' + ' <p> Gracias por inscribirse en el sistema de banca por Internet en línea de Carter Bank ! </p><br/><p> Se adjunta la contraseña temporal. Por favor utilice este para iniciar sesión en su cuenta en https://www.carterbankandtrustonline.com . A continuación se le pedirá que cambie su identificador de usuario y una contraseña . Si no puede acceder al sistema en el futuro, que sería capaz de restablecer su contraseña a la temporal hace referencia a continuación . De lo contrario , por razones de seguridad y privacidad, sólo será capaz de comunicar su contraseña temporal por correo, o en persona a la presentación de una identificación apropiada. </p><br/> <p> Una vez más, gracias por permitir Carter Bank la oportunidad de servirle </p> <br/> <p style="text-align: center;"> P/W: <b> ' + data.password + ' </b> </p>';
        },
        userLoginUserId: function(data){
            return '<p> Estimado ' + data.customerName + ' , </p> ' + ' <p> Gracias por inscribirse en el sistema de banca por Internet en línea de Carter Bank ! </p><br/><p> Cerrado es tu ID de usuario temporal. Por favor utilice este para iniciar sesión en su cuenta en https://www.carterbankandtrustonline.com . A continuación se le pedirá que cambie su identificador de usuario y una contraseña . Si no puede acceder al sistema en el futuro, que sería capaz de restablecer su contraseña a la temporal hace referencia a continuación . De lo contrario , por razones de seguridad y privacidad, sólo será capaz de comunicar su contraseña temporal por correo, o en persona a la presentación de una identificación apropiada. </p><br/> <p> Una vez más, gracias por permitir Carter Bank la oportunidad de servirle </p> <br/> <p style="text-align: center;"> Identidad de usuario: <b> ' + data.userName + ' </b> </p><p style="text-align: center;"> Su contraseña será enviada por separado . </p>';
        },
        ...
        changedFTL: function(data){
            return '<p>Estimado '+ data.customerName+', </p>'+'<p>Su banca por Internet se activa con la identificación de usuario <b>'+ data.userName +'</b> .</p><br/>';
        },
        ...
        customerOnboardingUserMail: function(data){
            return '<p>Estimado '+ data.customerName+', </p>'+'<p>Su identificación de usuario de inicio de sesión es <b> '+ data.userName +' </b>. Por razones de seguridad, Para compartir su identificación de usuario con cualquier persona, incluido el personal del banco.</p><br/>';
        },
