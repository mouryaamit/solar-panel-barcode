(function(){
    ...
    EmailTemplate.prototype = {
        ...
        userLoginPassword: function(data){
            return '<p>Dear '+ data.customerName+', </p>'+'<p>Thank you for enrolling in Carter Bank&#39;s on-line Internet banking system!</p><br/> <p>Enclosed is your temporary password.  Please use this to sign into your account at https://www.carterbankandtrustonline.com.  You will then be asked to change your user id and password. If you are unable to access the system in the future, we would be able to reset your password to the temporary one referenced below.  Otherwise, for security and privacy reasons, we will only be able to communicate your temporary password by mail, or in person upon presentment of proper identification.</p><br/><p>Once again, thank you for allowing Carter Bank the opportunity to serve you!</p><br/><p style="text-align: center;">Password: <b>'+ data.password +'</b></p>';
        },
        userLoginUserId: function(data){
            return '<p>Dear '+ data.customerName+', </p>'+'<p>Thank you for enrolling in Carter Bank&#39;s on-line Internet banking system!</p><br/> <p>Enclosed is your temporary user ID.  Please use this to sign into your account at https://www.carterbankandtrustonline.com.  You will then be asked to change your user id and password. If you are unable to access the system in the future, we would be able to reset your password to the temporary one referenced below.  Otherwise, for security and privacy reasons, we will only be able to communicate your temporary password by mail, or in person upon presentment of proper identification.</p><br/><p>Once again, thank you for allowing Carter Bank the opportunity to serve you!</p><br/><p style="text-align: center;"> User ID: <b>'+ data.userName +'</b></p><p style="text-align: center;">Your Temporary password will be mailed separately.</p>';
        },
        ...
        changedFTL: function(data){
            return '<p>Dear '+ data.customerName+', </p>'+'<p>Your Internet Banking is activated with User Id <b>'+ data.userName +'</b></p><br/>';
        },
        ...
        customerOnboardingUserMail: function(data){
            return '<p>Dear '+ data.customerName+', </p>'+'<p>Your Login User Id is <b>'+data.userName+'</b><br/>For security reasons we recommend you not to share your user id with anyone including bank staff.</p><br/>';
        },
