(function(){
    ...
    EmailTemplate.prototype = {
        ...
        changedPassword: function(data){
            return '<p>Dear '+ data.customerName+', </p>'+'<p>Your Password was recently changed. For security reasons, we recommend you not to share your password with anyone including bank staff.</p><br/>';
        },
