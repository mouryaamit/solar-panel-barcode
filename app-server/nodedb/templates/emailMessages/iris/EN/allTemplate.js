(function(){
    ...
    EmailTemplate.prototype = {
        ...
        activeUsersReportHeaders: function(){
            return '<br/><table style="width: 100%">'+
                '<thead>'+
                '<tr>'+
                '<td style="font-size: 13px;border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black;">Customer Id</td>'+
                '<td style="font-size: 13px;border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black;">Customer Name</td>'+
                '<td style="font-size: 13px;border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black;">User ID</td>'+
                '<td style="font-size: 13px;border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black;">Last Login IP</td>'+
                '<td style="font-size: 13px;border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black;">Login Count</td>'+
                '</tr>'+
                '</thead>'
        },
        activeUsersReportBody: function(data){
            var dataColl = '';
            for(var i = 0; i <5; i++){
                dataColl += '<tr>'+
                    '<td style="font-size: 8px;border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;">'+ data[i].customersId +'</td>'+
                    '<td style="font-size: 8px;border-right: 1px solid black;border-bottom: 1px solid black;">'+ data[i].customerName +'</td>'+
                    '<td style="font-size: 8px;border-right: 1px solid black;border-bottom: 1px solid black;">'+ data[i].userId +'</td>'+
                    '<td style="font-size: 8px;border-right: 1px solid black;border-bottom: 1px solid black;">'+ data[i].lastLoginIp +'</td>'+
                    '<td style="font-size: 8px;border-right: 1px solid black;border-bottom: 1px solid black;">'+ data[i].loginCount +'</td>'+
                    '</tr>';
            }
        ...
        resetSecurityQuestions: function(data){
            return '<p>Dear '+ data.customerName +',</p><p>As per your request we have reset your security questions. You are requested to change security questions on login.</p><br/>';
        },
        forgottenUserId: function(data){
            return '<p>Dear '+ data.customerName +',</p><p>As per your request we have retrieved your UserID. Your userID is <b>'+ data.userId +'</b></p><p>For security reasons we recommend you not to share your userId with anyone including bank staff. </p><br/>';
        },
        ...
        otpAuthFactor: function(data){
            return '<p>One time password (OTP) for your transaction is ' + data.otp + '</p><p>Bank never calls to verify your OTP. Do not disclose OTP to anyone.</p>';
        },
        ...
        bankAdminPasswordChanged : function(data){
            return '<p>Dear Admin,</p><p>Your Password Has Been Changed Successfully</b></p><p>For security reasons we recommend you not to share your password with anyone including bank staff. </p><br/>';
        },
        bankAdminLocked : function(data){
            return '<p>Dear Admin,</p><p>Your Profile Has Been Locked Due to multiple failed login attempts</b></p><br/>';
        },
        bankAdminLockedBySupervisor : function(data){
            return '<p>Dear Admin,</p><p>Your Profile Has Been Locked By Supervisor</b></p><br/>';
        },
        bankAdminUnlocked : function(data){
            return '<p>Dear Admin,</p><p>Your Profile Has Been Unlocked By Supervisor</b></p><br/>';
        },
        bankAdminDeleted : function(data){
            return '<p>Dear Admin,</p><p>Your Profile Has Been Deactivated By Supervisor</b></p><br/>';
        },
        bankAdminProfileChanged : function(data){
            return '<p>Dear Admin,</p><p>Your Profile Has Been Changed Successfully</b></p><br/>';
        },
        userLoginPassword: function(data){
            return '<p>Dear '+ data.customerName+', </p>'+'<p>Thank you for enrolling on-line Internet banking system!</p><br/> <p>Enclosed is your temporary password. You will then be asked to change your user id and password. If you are unable to access the system in the future, we would be able to reset your password to the temporary one referenced below.  Otherwise, for security and privacy reasons, we will only be able to communicate your temporary password by mail, or in person upon presentment of proper identification.</p><br/><p style="text-align: center;">Password: <b>'+ data.password +'</b></p>';
        },
        userLoginUserId: function(data){
            return '<p>Dear '+ data.customerName+', </p>'+'<p>Thank you for enrolling on-line Internet banking system!</p><br/> <p>Enclosed is your temporary user ID. You will then be asked to change your user id and password. If you are unable to access the system in the future, we would be able to reset your password to the temporary one referenced below.  Otherwise, for security and privacy reasons, we will only be able to communicate your temporary password by mail, or in person upon presentment of proper identification.</p><br/><p style="text-align: center;"> User ID: <b>'+ data.userName +'</b></p><p style="text-align: center;">Your Temporary password will be mailed separately.</p>';
        },
        ...
        customerOnboardingUserMail: function(data){
            return '<p>Dear '+ data.customerName+', </p>'+'<p>Your Login Username is <b>'+data.userName+'</b><br/>For security reasons we recommend you not to share your username with anyone including bank staff.</p><br/>';
        },
        customerOnboardingPasswordMail: function(data){
            return '<p>Dear '+ data.customerName+', </p>'+'<p>Your Login Password is <b>'+data.password+'</b><br/>For security reasons we recommend you not to share your password with anyone including bank staff.</p><br/>';
        }
    };
